...
DATABASE_URL="sqlite:///Users/evanmac/.codeclimbers/codeclimbers-desktop.sqlite?mode=rwc"

Make sure to build monitoring-service first, then monitor service, and finally. npm run tauri dev.
